...
namespace AirlinesApp.Db
{
    public class DBSeeder : IDBSeeder
    {
        ...
        private void AddDataToDB()
        {
            ...
            Flight f2 = AddFlightToDbContext("F6788", ap1, ai4, ai2, 33);
            Flight f3 = AddFlightToDbContext("F2235", ap1, ai5, ai4, 120);
            Flight f4 = AddFlightToDbContext("F8542", ap2, ai4, ai2, 45);
            Flight f5 = AddFlightToDbContext("F3435", ap2, ai2, ai1, 57);
            Flight f6 = AddFlightToDbContext("F0283", ap2, ai5, ai4, 80);
            Flight f7 = AddFlightToDbContext("F5234", ap3, ai3, ai5, 24);
            Flight f8 = AddFlightToDbContext("F1234", ap3, ai5, ai5, 78);
            Flight f9 = AddFlightToDbContext("F4682", ap3, ai4, ai2, 134);
            Flight f10 = AddFlightToDbContext("F1344", ap4, ai1, ai3, 47);
            Flight f11 = AddFlightToDbContext("F9732", ap4, ai5, ai2, 76);
            Flight f12 = AddFlightToDbContext("F4663", ap4, ai3, ai1, 89);
            Flight f13 = AddFlightToDbContext("F9765", ap5, ai4, ai5, 110);
            Flight f14 = AddFlightToDbContext("F2235", ap5, ai1, ai2, 120);
            Flight f15 = AddFlightToDbContext("F7532", ap5, ai4, ai2, 90);
            Flight f16 = AddFlightToDbContext("F9676", ap6, ai4, ai5, 110);
            Flight f17 = AddFlightToDbContext("F2344", ap6, ai4, ai3, 120);
            Flight f18 = AddFlightToDbContext("F3476", ap6, ai4, ai3, 90);
            Flight f19 = AddFlightToDbContext("F5675", ap7, ai3, ai1, 50);
            Flight f20 = AddFlightToDbContext("F6576", ap7, ai5, ai2, 33);
            Flight f21 = AddFlightToDbContext("F2tt5", ap3, ai4, ai4, 120);

            Flight f22= AddFlightToDbContext("F3242", ap8, ai4, ai2, 45);
            Flight f23 = AddFlightToDbContext("F4fr5", ap8, ai2, ai1, 57);
            Flight f24 = AddFlightToDbContext("F0er4", ap8, ai1, ai4, 80);
            Flight f25 = AddFlightToDbContext("F535g", ap9, ai3, ai5, 24);
            Flight f26 = AddFlightToDbContext("F1244", ap9, ai2, ai5, 78);
            Flight f27 = AddFlightToDbContext("F4hk2", ap9, ai4, ai2, 134);
            Flight f28 = AddFlightToDbContext("F1364", ap10, ai1, ai4, 47);
            Flight f29 = AddFlightToDbContext("F95h2", ap10, ai5, ai2, 76);
            Flight f30 = AddFlightToDbContext("F4ws3", ap10, ai3, ai1, 89);
            Flight f31 = AddFlightToDbContext("Fd465", ap11, ai4, ai5, 110);
            Flight f32 = AddFlightToDbContext("F29o5", ap11, ai1, ai3, 120);
            Flight f33 = AddFlightToDbContext("F3ff2", ap11, ai4, ai1, 90);
            Flight f34 = AddFlightToDbContext("F99h6", ap12, ai4, ai4, 110);
            Flight f35 = AddFlightToDbContext("F9044", ap12, ai4, ai2, 120);
            Flight f36 = AddFlightToDbContext("F3yu6", ap12, ai4, ai1, 90);
            Flight f37 = AddFlightToDbContext("F3ff2", ap12, ai4, ai3, 90);
            Flight f38 = AddFlightToDbContext("F99h6", ap1, ai4, ai5, 110);
            Flight f39 = AddFlightToDbContext("F9044", ap1, ai4, ai4, 120);
            Flight f40 = AddFlightToDbContext("F3yu6", ap2, ai4, ai5, 90);
